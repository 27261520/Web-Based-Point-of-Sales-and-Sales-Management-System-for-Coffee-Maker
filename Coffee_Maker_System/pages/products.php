...
<head>
	...
	<style>
		* { box-sizing: border-box; margin: 0; padding: 0; }
		...
		.menu-tabs { display: flex; gap: 5px; margin-top: 15px; } .menu-tab { padding: 5px 9px; border-radius: 5px; background: #e4e2e1; color: #4a3933; font-size: 9px; font-weight: 700; text-decoration: none; } .menu-tab.active { background: #74473b; color: #fff; }
		.product-toolbar { margin-bottom: 18px; } .product-search { width: min(100%, 330px); height: 38px; padding: 0 13px; border: 1px solid #e5e1df; border-radius: 6px; background: #fff; font-size: 11px; } .category-filters { display: flex; flex-wrap: wrap; gap: 8px; margin-top: 11px; } .category-filter { border: 0; border-radius: 15px; padding: 7px 12px; background: #ece8e6; color: #5d4b44; font-size: 10px; cursor: pointer; } .category-filter.active, .category-filter:hover { background: #74473b; color: #fff; }
		.category-table-wrap { overflow-x: auto; border: 1px solid #eeeae8; border-radius: 8px; background: #fff; } .category-table { width: 100%; min-width: 650px; border-collapse: collapse; } .category-table th { padding: 13px 15px; background: #fffaf5; color: #72574c; font-size: 9px; text-align: left; } .category-table td { padding: 14px 15px; border-top: 1px solid #f0edeb; color: #6f625c; font-size: 10px; } .category-table td:first-child { width: 45px; text-align: center; } .category-name { color: #4d3026; font-weight: 700; } .category-status { display: inline-block; padding: 4px 8px; border-radius: 3px; background: #2eae55; color: #fff; font-size: 9px; }
		.category-actions { display: flex; gap: 8px; } .category-actions a { width: 28px; height: 28px; display: grid; place-items: center; border: 1px solid #e6ded9; border-radius: 4px; color: #70483a; text-decoration: none; } .category-actions a.delete { color: #b33d35; }
		.category-edit-page { background: #fff; border: 1px solid #e7e1df; border-radius: 8px; padding: 24px; } .category-edit-heading { display: flex; align-items: center; gap: 12px; margin-bottom: 24px; } .category-edit-heading a { color: #70483a; text-decoration: none; font-size: 22px; } .category-edit-heading h2 { font-size: 19px; } .category-edit-heading p { margin-top: 5px; color: #766e6a; font-size: 11px; }
		.category-form-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 0 18px; } .category-form-grid textarea { min-height: 90px; } .category-status-field { margin-top: 16px; color: #54423b; font-size: 11px; } .category-status-field input { width: auto; height: auto; margin-right: 7px; } .category-form-note { margin-top: 8px; color: #8d817c; font-size: 10px; }
		.category-modal { position: fixed; inset: 0; z-index: 30; display: grid; place-items: center; padding: 20px; background: rgba(43, 22, 16, .28); } .category-confirm { width: min(100%, 405px); padding: 20px; border-radius: 8px; background: #fff; box-shadow: 0 10px 25px rgba(43,22,16,.18); text-align: center; } .warning-icon { width: 42px; height: 42px; display: grid; place-items: center; margin: 0 auto 14px; border-radius: 50%; background: #ffd9d7; color: #c51f24; font-size: 21px; } .category-confirm h2 { font-size: 18px; } .category-confirm p { margin: 8px auto 14px; max-width: 285px; color: #6f625c; font-size: 11px; line-height: 1.5; } .impact-box { padding: 12px; border: 1px solid #e5dedb; border-radius: 6px; background: #f5f1f0; color: #6f625c; text-align: left; font-size: 10px; line-height: 1.45; } .confirm-actions { display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-top: 18px; } .confirm-actions form { width: 100%; } .confirm-actions a, .confirm-actions button { width: 100%; min-height: 34px; padding: 10px; border: 1px solid #bca9a1; border-radius: 5px; background: #fff; color: #4d3026; text-decoration: none; font-size: 10px; cursor: pointer; text-align: center; } .confirm-actions button { border-color: #c51f24; background: #c51f24; color: #fff; }
		...
		.product-image { height: 232px; background: #b2acab; display: grid; place-items: center; color: #342c29; font-size: 54px; overflow: hidden; } .product-image img { width: 100%; height: 100%; object-fit: cover; }
		.add-product-card { display: block; color: #74473b; text-decoration: none; } .add-product-image { height: 232px; display: grid; place-items: center; background: #b2acab; } .add-product-image span { width: 104px; height: 104px; display: grid; place-items: center; border: 1px solid #342c29; border-radius: 50%; color: #342c29; font-size: 54px; font-weight: 300; line-height: 1; } .add-product-info { min-height: 140px; padding: 27px 25px; background: #fff; } .add-product-info h3 { color: #74473b; font-size: 24px; line-height: 1.35; }
		...
		.addon-row { display: grid; grid-template-columns: minmax(0, 1fr) 82px 32px; gap: 8px; margin-top: 8px; } .remove-addon { border: 1px solid #e0d5d1; border-radius: 5px; background: #fff; color: #9b3024; cursor: pointer; font-size: 17px; } .add-addon { border: 0; background: transparent; color: #74473b; cursor: pointer; font-size: 0; font-weight: 700; } .add-addon::after { content: "+ ADD"; font-size: 10px; }
		.edit-modal { position: fixed; inset: 0; z-index: 20; display: grid; place-items: center; padding: 22px; background: rgba(43, 22, 16, .58); } .edit-modal .panel { width: min(100%, 430px); max-height: calc(100vh - 44px); overflow-y: auto; }
...
<main class="app-shell">
	<aside class="sidebar">
		...
		<div class="sidebar-footer"><div class="user"><div class="avatar">♙</div><span><?= htmlspecialchars($admin_name) ?></span></div><a class="settings" href="settings.php" aria-label="Settings" title="Settings">⚙</a></div>
	</aside>
	<section class="content">
		<header class="topbar"><div><h1>Menu Management</h1><div class="menu-tabs"><a class="menu-tab <?= $active_tab === "categories" ? "active" : "" ?>" href="products.php?tab=categories">CATEGORIES</a><a class="menu-tab <?= $active_tab === "products" ? "active" : "" ?>" href="products.php?tab=products">PRODUCTS</a></div></div><?php if ($active_tab === "categories"): ?><a class="add-button" href="products.php?tab=categories&add_category=1">+ ADD CATEGORY</a><?php endif; ?></header>
		<?php if ($message !== ""): ?><div class="message"><?= htmlspecialchars($message) ?></div><?php endif; ?>
		<?php if ($active_tab === "categories"): ?>
		<?php if (isset($_GET["add_category"])): ?><section class="panel" style="margin-bottom: 20px;"><h2>Add Category</h2><form method="post"><input type="hidden" name="action" value="save_category"><label for="category-name">CATEGORY NAME</label><input id="category-name" name="category_name" placeholder="e.g. Coffee" required><label for="category-description">DESCRIPTION</label><input id="category-description" name="category_description" placeholder="Premium coffee beverages"><div class="form-actions"><a class="cancel-link" href="products.php?tab=categories">CANCEL</a><button class="save-button" type="submit">ADD CATEGORY</button></div></form></section><?php endif; ?>
		<?php if ($edit_category): ?><section class="category-edit-page"><div class="category-edit-heading"><a href="products.php?tab=categories" aria-label="Back to categories">←</a><div><h2>Edit Category</h2><p>Update details for “<?= htmlspecialchars($edit_category["name"]) ?>”</p></div></div><form method="post"><input type="hidden" name="action" value="save_category"><input type="hidden" name="category_id" value="<?= (int) $edit_category["id"] ?>"><div class="category-form-grid"><div><label for="edit-category-name">CATEGORY NAME</label><input id="edit-category-name" name="category_name" value="<?= htmlspecialchars($edit_category["name"]) ?>" required></div><div><label for="sort-order">SORT ORDER</label><input id="sort-order" name="sort_order" type="number" min="1" value="<?= (int) $edit_category["sort_order"] ?>" required></div></div><label for="edit-category-description">DESCRIPTION</label><textarea id="edit-category-description" name="category_description"><?= htmlspecialchars($edit_category["description"]) ?></textarea><div class="category-status-field"><label for="category-status">STATUS</label><label><input id="category-status" type="checkbox" name="category_status" value="Active" <?= $edit_category["status"] === "Active" ? "checked" : "" ?>> Active</label><p class="category-form-note">Inactive categories will not appear on the POS system.</p></div><div class="form-actions"><a class="cancel-link" href="products.php?tab=categories">CANCEL</a><button class="save-button" type="submit">SAVE CHANGES</button></div></form></section><?php else: ?><section><h2 style="font-size: 15px; margin: 0 0 18px;">Categories</h2><div class="category-table-wrap"><table class="category-table"><thead><tr><th>#</th><th>NAME</th><th>DESCRIPTION</th><th>SORT ORDER</th><th>STATUS</th><th>ACTIONS</th></tr></thead><tbody><?php foreach ($category_rows as $index => $category): ?><tr><td><?= $index + 1 ?></td><td class="category-name"><?= htmlspecialchars($category["name"]) ?></td><td><?= htmlspecialchars($category["description"]) ?></td><td><?= (int) $category["sort_order"] ?></td><td><span class="category-status">Active</span></td><td><div class="category-actions"><a href="products.php?tab=categories&amp;edit_category=<?= (int) $category["id"] ?>" aria-label="Edit <?= htmlspecialchars($category["name"]) ?>">✎</a><a class="delete" href="products.php?tab=categories&amp;delete_category=<?= (int) $category["id"] ?>" aria-label="Delete <?= htmlspecialchars($category["name"]) ?>">▮</a></div></td></tr><?php endforeach; ?><?php if (!$category_rows): ?><tr><td colspan="6">No categories yet.</td></tr><?php endif; ?></tbody></table></div></section><?php endif; ?>
		<?php if ($delete_category): ?><div class="category-modal"><section class="category-confirm"><div class="warning-icon">▲</div><h2>Delete Category?</h2><p>Are you sure you want to delete the “<?= htmlspecialchars($delete_category["name"]) ?>” category? This will also delete all products currently assigned to it.</p><div class="impact-box"><strong>ⓘ &nbsp; Impact</strong><br>All products in this category will be removed from the menu and will no longer appear on the POS system.</div><div class="confirm-actions"><a href="products.php?tab=categories">Cancel</a><form method="post"><input type="hidden" name="action" value="delete_category"><input type="hidden" name="category_id" value="<?= (int) $delete_category["id"] ?>"><button type="submit">&#128465; Delete</button></form></div></section></div><?php endif; ?>
		<?php else: ?>
		<div class="management-grid">
			<section class="panel"><h2>Products</h2><div class="product-toolbar"><input class="product-search" id="product-search" type="search" placeholder="⌕  Search menu items..." aria-label="Search menu items"><div class="category-filters"><button class="category-filter active" type="button" data-category="all">All</button><?php foreach ($categories as $category): ?><button class="category-filter" type="button" data-category="<?= htmlspecialchars($category) ?>"><?= htmlspecialchars($category) ?></button><?php endforeach; ?></div></div><div class="product-grid">
				<?php foreach ($products as $product): ?><article class="product-card" data-name="<?= htmlspecialchars(strtolower($product["product_name"])) ?>" data-category="<?= htmlspecialchars($product["category"]) ?>"><div class="product-image"><?php if (!empty($product["image_path"])): ?><img src="../<?= htmlspecialchars($product["image_path"]) ?>" alt="<?= htmlspecialchars($product["product_name"]) ?>"><?php else: ?>☕<?php endif; ?></div><div class="product-info"><div class="category-label"><?= htmlspecialchars($product["category"]) ?></div><h3><?= htmlspecialchars($product["product_name"]) ?></h3><div class="price">₱<?= number_format((float) $product["price"], 2) ?></div><?php $product_addons = decode_addons($product["addons"] ?? ""); if (count($product_addons) > 0): ?><div class="category-label">Add-ons: <?= htmlspecialchars(implode(", ", array_map(fn($addon) => $addon["name"] . " (+₱" . number_format($addon["price"], 2) . ")", $product_addons))) ?></div><?php endif; ?><div class="card-actions"><a class="icon-button" href="products.php?edit=<?= (int) $product["id"] ?>#product-form" aria-label="Edit <?= htmlspecialchars($product["product_name"]) ?>" title="Edit product">✎</a><form method="post" onsubmit="return confirm('Remove this product from the menu?');"><input type="hidden" name="action" value="delete"><input type="hidden" name="product_id" value="<?= (int) $product["id"] ?>"><button class="delete-button" type="submit" aria-label="Delete <?= htmlspecialchars($product["product_name"]) ?>" title="Delete product">⌫</button></form></div></div></article><?php endforeach; ?>
				<a class="product-card add-product-card" href="add_product.php" aria-label="Add new product"><div class="add-product-image" aria-hidden="true"><span>＋</span></div><div class="add-product-info"><h3>ADD NEW<br>PRODUCT</h3></div></a>
				<?php if (count($products) === 0): ?><p class="subtitle">No active products yet.</p><?php endif; ?>
			</div></section>
			<?php if ($edit_product): ?><div class="edit-modal" id="edit-modal"><aside class="panel" id="product-form"><h2>Edit Product</h2><form method="post" enctype="multipart/form-data"><input type="hidden" name="action" value="save"><input type="hidden" name="product_id" value="<?= (int) $edit_product["id"] ?>"><input type="hidden" name="current_image" value="<?= htmlspecialchars($edit_product["image_path"] ?? "") ?>"><label for="product-name">PRODUCT NAME</label><input id="product-name" name="product_name" value="<?= htmlspecialchars($edit_product["product_name"] ?? "") ?>" placeholder="e.g. Classic Beef Tapa" required><label for="category">CATEGORY</label><input id="category" name="category" list="category-options" value="<?= htmlspecialchars($edit_product["category"] ?? "") ?>" placeholder="e.g. Snacks" required><datalist id="category-options"><?php foreach ($categories as $category): ?><option value="<?= htmlspecialchars($category) ?>"><?php endforeach; ?></datalist><label for="price">PRICE</label><input id="price" name="price" type="number" min="0" step="0.01" value="<?= htmlspecialchars($edit_product["price"] ?? "") ?>" placeholder="0.00" required><div class="addons-heading"><label>ADD ONS &amp; TOPPINGS</label><button class="add-addon" id="add-addon" type="button">+ ADD ADD-ON</button></div><div id="addons-list"><?php foreach ($form_addons as $addon): ?><div class="addon-row"><input type="text" name="addons[]" value="<?= htmlspecialchars($addon["name"]) ?>" placeholder="e.g. Extra shot"><input type="number" name="addon_prices[]" min="0" step="0.01" value="<?= htmlspecialchars($addon["price"]) ?>" placeholder="Price"><button class="remove-addon" type="button" aria-label="Remove add-on">×</button></div><?php endforeach; ?></div><label for="product-image">PRODUCT PICTURE</label><input id="product-image" name="product_image" type="file" accept="image/jpeg,image/png,image/webp"><div class="form-actions"><button class="save-button" type="submit">SAVE CHANGES</button><a class="cancel-link" href="products.php">CANCEL</a></div></form></aside></div><?php endif; ?>
		</div>
		<?php endif; ?>
	</section>
</main>
